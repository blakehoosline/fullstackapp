...
export class Department extends Component{
    ...
    //constructor to define the state variables
    constructor(props) {
        // call constructor
        super(props);

        //define array to be then populated with departments data from api
        this.state={
            departments:[], 
            modalTitle:"",
            DepartmentName:"",
    ...
    //refresh the departments data from get api method
    refreshList() {
    ...
    //call refresh once component is mounted
    componentDidMount() {
        this.refreshList();
    };

    componentDepartmentName = (e) => {
    ...
    render(){
        //declare state variables to use in html
        const {
            departments,
            modalTitle,
            DepartmentId,
        ...
        return(
            <div>
                <button type = "button" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" onClick={()=>this.addClick()}>Add Department</button>
